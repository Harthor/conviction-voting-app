const { usePlugin } = require('@nomiclabs/hardhat/config')
const hooks = require('./scripts/hardhat-hooks') 

usePlugin('@aragon/buidler-aragon') //keep an eye to migrate to hardhat
usePlugin('@nomiclabs/hardhat-solhint')
usePlugin('buidler-gas-reporter') // keep an eye to migrate to hardhat
...
module.exports = {
  ...
  networks: {
    ...
    // https://frame.sh
    frame: {
      httpHeaders: { origin: 'buidler' }, // keep an eye
